...
<head>
<meta charset="utf-8">
<title>error-pre-versions-of-node-cannot-be-installed.html</title>
<meta name="viewport" content="width=device-width,initial-scale=1">
</head>
<body>
<pre>When using `node-gyp` you might see an error like this when attempting to compile/install a node.js native addon:
